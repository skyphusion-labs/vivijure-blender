...
class _BodyRejected:
    ...
    fc#1592: _body() answered None for three different situations (no body at all, a body
    ...
    went unnoticed. Proven by control: 1.2 MB accepted then FAILED on a missing clip_key,
    the identical payload at 1 KB COMPLETED.
    """
...
def route(
    ...
    *,
    ...
    if method == "POST" and path == "/run":
        ...
        if err:
            return err
        # Refuse a rejected body instead of silently running an EMPTY job (fc#1592).
